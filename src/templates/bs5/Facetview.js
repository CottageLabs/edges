...
if (!edges.templates.hasOwnProperty("bs5")) { edges.templates.bs5 = {}}

edges.templates.bs5.Facetview = class extends edges.Template{
    constructor(params) {
        super(params);

        this.facetHeader = edges.util.getParam(params, "facetHeader", false);

        this.namespace = "edges-bs5-facetview";
        this.edge = false;
    }
    ...
    draw(edge) {
        ...
        let facetContainerClass = edges.util.styleClasses(this.namespace, "facet-container");
        ...
        if (facets.length > 0) {
            ...
            thefacetview += `<div class="col-md-3 ${facetContainerClass}">
                ${facetHeader}
