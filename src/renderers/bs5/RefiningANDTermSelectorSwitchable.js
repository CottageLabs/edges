...
edges.renderers.bs5.RefiningANDTermSelectorSwitchable = class extends edges.Renderer {
    constructor(params) {
        super(params);
        ...
        this.namespace = "edges-bs5-refining-and-term-selector";
    }
    ...
    draw() {
        ...
        var frag = '<div class="' + facetClass + '">\
                        <div class="' + headerClass + '"><div class="row ' + resultsListHeaderClass + '"> \
                                ' + tog + '\
                        </div></div>\
                        ' + tooltipFrag + '\
                        {{CONTROLS}}\
